    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_sum', models.DecimalField(decimal_places=2, max_digits=15, verbose_name='Сумма заказа')),
                ('payment_type', models.PositiveSmallIntegerField(choices=[(1, 'Наличными при получении'), (2, 'Картой')], verbose_name='Способ оплаты')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Оформлен'), (2, 'Ожидает оплату'), (3, 'Оплачен'), (4, 'Подтвержден'), (5, 'Выполнен'), (6, 'Аннулирован'), (7, 'Ошибка оплаты')], verbose_name='Статус заказа')),
                ('show_order_to_user', models.BooleanField(verbose_name='Показывать заказ пользователю')),
                ('delivery_type', models.PositiveSmallIntegerField(choices=[(1, 'Самовывоз'), (2, 'Доставка курьером')], verbose_name='Способ получения товара')),
